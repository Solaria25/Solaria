...
// @match         *://*/*
// @downloadURL   https://raw.githubusercontent.com/Solaria25/Solaria/main/solariascript.js @updateURL     https://raw.githubusercontent.com/Solaria25/Solaria/refs/heads/main/solariascript.js
// @grant         GM_setValue
// @grant         GM_getValue
...
(function () {
    ...
    style.textContent = `
        :root { --solaria-text-color: #333333; }
    ...
    const naturalLanguageEnhancements = [
        ...
        "You're too sweet", "I'm touched", "That's so thoughtful of you", "Fuck, that's s            padding: 12px 20px;
            font-size: 16px;
            font-weight: bold;
            border: none;
            border-radius: 30px;
